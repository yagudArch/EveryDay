...
| BCK-002 | P1 | BACKEND | TODO (ready) | BCK-001 ✓ | apps/backend/**, database/migrations/** | РАЗБЛОКИРОВАНА: BCK-001 DONE (миграция 0003 опубликована → следующая 0004). Готова к запуску BACKEND. Memory CRUD/delete-all/disable и учёт consent; экспорт/удаление аккаунта, cascade tests |
