...
| FND-005 | P0 | QA/DEVOPS + LEAD | BLOCKED | FND-002, FND-003, FND-004 | scripts/**, .github/**, apps/mobile/package.json, lockfile, .ai/** | Повторный независимый gate cd55dcd: clean npm ci, builds/typecheck, Expo/Metro all, smoke 2/2, migration apply/skip PASS; remote CI Ubuntu/Windows run 35465046166 success. Новый blocker: check в произвольно названной чистой копии 225/226, migrations.test.ts:34 требует имя EveryDay; исходный checkout 226/226 PASS. BACKEND/LEAD исправить переносимость теста и повторить gate. Audit 12 moderate, отдельное решение LEAD. Актуальный отчёт FND-005-REPORT.md |
