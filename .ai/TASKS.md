...
| BCK-001 | P0 | BACKEND | TODO (ready) | FND-006 ✓, NUT-001 ✓ | apps/backend/src/auth/**, database/migrations/** | РАЗБЛОКИРОВАНА: NUT-001 DONE, миграция 0002 опубликована → следующая миграция 0003. Готова к запуску BACKEND (роль свободна после NUT-001). Email verification, password reset, revoke-all sessions; transport/rate-limit hardening и тесты. Разблокирует BCK-002 |
