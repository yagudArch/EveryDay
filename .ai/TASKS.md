...
| FND-005 | P0 | QA/DEVOPS + LEAD | BLOCKED | FND-002, FND-003, FND-004 | scripts/**, .github/**, apps/mobile/package.json, lockfile, .ai/** | Dependency repair LEAD/MOBILE передан на REVIEW: чистый npm ci и Expo check PASS; check 226 tests, smoke 2/2, Metro all PASS. Требуется повторный полный Foundation gate QA/DEVOPS и CI matrix на исправленном commit; до этого не DONE. npm audit: 12 moderate для оценки QA. Исторический FAIL — FND-005-REPORT.md |
