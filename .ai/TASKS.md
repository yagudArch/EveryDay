...
| FND-005 | P0 | QA/DEVOPS + LEAD | BLOCKED | FND-002, FND-003, FND-004 | scripts/**, .github/**, lockfile, .ai/** | Foundation gate FAIL: npm ci EUSAGE (lockfile), Expo dependency check FAIL; владельцы LEAD/MOBILE. Check PASS 226 tests, builds/typecheck, Metro all, migrations и 2 сквозных smoke PASS. QA исправил отсутствующий smoke в CI; remote CI не подтверждён. См. FND-005-REPORT.md |
