...
- FND-005 TODO: доступна QA/DEVOPS для повторного preflight и запуска Foundation gate, зависимости выполнены, блокировка снята. Gate ещё не запускался; FND-005 не DONE. Отчёт QA 33610f1 / .ai/FND-005-REPORT.md сохраняет историческую блокировку до этой сдачи. FND-006 и последующие задачи не запускаются.
